...
static const struct nfs_error_info s_krb5_entries[] = {
    ...
    { KRB5_ERR_NO_NFS_PRINCIPAL,      KRB5_PHASE_PRE_FLIGHT,
      "NO_NFS_PRINCIPAL",
    ...
    { KRB5_ERR_NO_NFSIDMAP,           KRB5_PHASE_PRE_FLIGHT,
      "NO_NFSIDMAP",
      "nfsidmap binary not installed (NFSv4 id mapping will fail)",
      "Install the nfs-utils (or libnfsidmap) package",
      "no_nfsidmap" },
    ...
    { KRB5_ERR_RDNS_MISMATCH,         KRB5_PHASE_PRE_FLIGHT,
      "RDNS_MISMATCH",
    ...
    { KRB5_ERR_CLOCK_SKEW,            KRB5_PHASE_KERBEROS,
      "CLOCK_SKEW",
    ...
    { KRB5_ERR_TGT_EXPIRED,           KRB5_PHASE_KERBEROS,
      "TGT_EXPIRED",
      "User TGT has expired",
      "Run `kinit -R` to renew or `kinit user@REALM` to re-acquire",
      "tgt_expired" },

    { KRB5_ERR_TGT_NOT_YET_VALID,     KRB5_PHASE_KERBEROS,
      "TGT_NOT_YET_VALID",
    ...
    { KRB5_ERR_BAD_ENCTYPE,           KRB5_PHASE_KERBEROS,
      "BAD_ENCTYPE",
    ...
    { KRB5_ERR_PRINCIPAL_UNKNOWN,     KRB5_PHASE_KERBEROS,
      "PRINCIPAL_UNKNOWN",
    ...
    { KRB5_ERR_BAD_INTEGRITY,         KRB5_PHASE_KERBEROS,
      "BAD_INTEGRITY",
    ...
    { KRB5_ERR_PRINCIPAL_FORM,        KRB5_PHASE_KERBEROS,
      "PRINCIPAL_FORM",
    ...
    { KRB5_ERR_NOT_US,                KRB5_PHASE_KERBEROS,
      "NOT_US",
    ...
    { KRB5_ERR_BAD_REALM,             KRB5_PHASE_KERBEROS,
      "BAD_REALM",
    ...
    { KRB5_ERR_GSS_BAD_NAME,          KRB5_PHASE_GSS,
      "GSS_BAD_NAME",
    ...
    { KRB5_ERR_GSS_BAD_MECH,          KRB5_PHASE_GSS,
      "GSS_BAD_MECH",
    ...
    { KRB5_ERR_GSS_NO_CRED,           KRB5_PHASE_GSS,
      "GSS_NO_CRED",
    ...
    { KRB5_ERR_GSS_DEFECTIVE_TOKEN,   KRB5_PHASE_GSS,
      "GSS_DEFECTIVE_TOKEN",
    ...
    { KRB5_ERR_GSS_DEFECTIVE_CRED,    KRB5_PHASE_GSS,
      "GSS_DEFECTIVE_CRED",
      "GSS credential is malformed",
      "Re-run kinit; if persistent, file a libkrb5 bug",
      "gss_defective_cred" },

    { KRB5_ERR_GSS_CRED_EXPIRED,      KRB5_PHASE_GSS,
      "GSS_CRED_EXPIRED",
    ...
    { KRB5_ERR_GSS_CONTEXT_EXPIRED,   KRB5_PHASE_GSS,
      "GSS_CONTEXT_EXPIRED",
    ...
    { KRB5_ERR_GSS_BAD_MIC,           KRB5_PHASE_GSS,
      "GSS_BAD_MIC",
    ...
    { KRB5_ERR_RPCSEC_REPLAY,         KRB5_PHASE_RPCSEC_GSS,
      "RPCSEC_REPLAY",
    ...
    { KRB5_ERR_WRONGSEC,              KRB5_PHASE_RPCSEC_GSS,
      "WRONGSEC",
    ...
    { KRB5_ERR_SECINFO_EMPTY,         KRB5_PHASE_RPCSEC_GSS,
      "SECINFO_EMPTY",
    ...
    { KRB5_ERR_NULL_REJECTED,         KRB5_PHASE_RPCSEC_GSS,
      "NULL_REJECTED",
    ...
    { KRB5_ERR_IDMAP_NOBODY,          KRB5_PHASE_IDMAP,
      "IDMAP_NOBODY",
    ...
    { KRB5_ERR_IDMAP_PLUGIN_FAILED,   KRB5_PHASE_IDMAP,
      "IDMAP_PLUGIN_FAILED",
    ...
    { KRB5_ERR_IDMAPD_NOT_RUNNING,    KRB5_PHASE_IDMAP,
      "IDMAPD_NOT_RUNNING",
     ...
     * renders as "?".
     */
    { NFS_ERR_MIXED,                  KRB5_PHASE_NUM,
      "MIXED",
      "Multiple distinct krb5 failure classes occurred in one run",
      "Inspect the per-phase Error breakdown for details",
      "mixed" },

    { NFS_ERR_INTERNAL,               KRB5_PHASE_NUM,
      "INTERNAL",
